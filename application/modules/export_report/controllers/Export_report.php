        ...
        for ($i = 1; $i <= $data['count_rec']; $i++) {
            if (!empty($data['tax'][10][$i]['notice_estimate']['year'])) {
                ...
                $content .= '<tr>
                            ...
                            <td>' . chkNo(@$data['tax'][10][$i]['notice_estimate']['notice_estimate']) . '</td>
                            ...
                            <td>' . chkNo(@$data['tax'][10][$i]['tax_receive']['receive_amount']) . '</td>
