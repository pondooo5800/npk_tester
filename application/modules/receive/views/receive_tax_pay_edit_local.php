      ...
      <div class="form-horizontal form-label-left">
        ...
        <div class="form-group">
                         <label class="control-label col-md-4 col-sm-3 col-xs-12"  for="id_tax"> ชำระภาษีบำรุงท้องที่ปี
                             ...
                             <div class="col-md-4 col-sm-6 col-xs-12">
                             <?php
 							 $year_receive = $tax_pay[0]['year_receive'];
							    #/ <?php echo $value->tax_year_id; 
							  ?>
                                     <select class="form-control" name="year_receive" >
                                         <?php foreach ($tax_years as $value) : ?>
                                            <?php if ($year_receive == $value->tax_year_id) : ?>
        ...
        <div class="form-group">
                <label class="control-label col-md-4 col-sm-3 col-xs-12" for="id_tax">รวมจำนวนเงินที่ต้องชำระ
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                    <?php #value="<?php echo $tax_pay[0]['sum_amount'] ?>
                        <input style="text-align: right;" type="text" placeholder="0.00" id="sum_amount"  name="sum_amount" readonly class="cal numeric form-control col-md-7 col-xs-12" value="<?php echo $tax_notice[0]['tax_estimate'] - $tax_notice[0]['tax_amount'] ?>">
                    </div>
        </div>
