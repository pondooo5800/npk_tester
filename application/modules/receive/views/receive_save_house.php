...
<div class="right_col" role="main">
            <section class="row">
                  <div class="col-md-8 col-sm-4 col-xs-4">
                      <h3>ข้อมูลรายรับภาษีโรงเรือนและที่ดิน</h3>
                  </div>
                  <div class="col-md-4 col-sm-8 col-xs-8 text-right" style="margin-top: 7px;">
                      <div class="btn-group">
                        <button style="width: 130px;" onclick="window.location.replace('search_tax_house');" type="button" class="btn btn-success" title="ชำระภาษี"><i class="fa fa-paypal"></i> ชำระภาษี
                        </button>
                      </div>
                  </div>
            </section>
