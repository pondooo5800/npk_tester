...
<div class="page-title">
  <div class="title_left">
    <h3>จ่ายภาษีโรงเรือนและที่ดิน</h3>
  </div>
</div>
  <br>
  <br>
...
<div class="row">
  ...
  <form action="<?php echo base_url('receive/recieve_tax_update_house') ?>" method="post">
        ...
        <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <br>
                      ...
                      <button onclick="window.location.replace('<?php echo site_url('receive/receive_save_house'); ?>');" type="button" class="btn btn-warning"><i class="fa fa-close"></i> ยกเลิก
                      </button>
                  </div>
              </div>   
              <hr>
